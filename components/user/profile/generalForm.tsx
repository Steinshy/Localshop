          ...
          {({ errors, isSubmitting }) => (
            <Form className="flex flex-col gap-2">
              <div className="grid grid-cols-2 gap-2">
                <FieldsBuilder fields={{ firstname: { placeholder: 'John' }, lastname: { placeholder: 'Doe' } }} busy={isSubmitting} errors={errors} />
              </div>

              <div>
                <FieldsBuilder fields={{ email: { placeholder: 'email@domain.com', type: 'email' } }} busy={isSubmitting} errors={errors} />
              </div>
