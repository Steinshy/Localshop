...
const ProductsList: FC<ProductsListProp> = ({ data, pagy, categorySlug }) => {
  ...
  const fetch = useCallback(
    ...
    [localPagy.pages, isFetching, searchParams, categorySlug]
  );
  ...
  const handleFetch = (page?: number, query?: string) => {
    void fetch(page, query);
  ...
  return (
    <>
      {/* Search form */}
      <SearchBar query={query} setQuery={setQuery} fetch={handleFetch} isFetching={isFetching} />
