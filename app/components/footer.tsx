...
// import { Grid, List, ListItem, Link } from '@nextui-org/react';
...
//       </Link>
//       {isTag && (
//         <span className="text-white font-bold bg-teal-600 px-1 rounded-md text-sm mb-3 ml-1 inline-flex items-center">
//           {tagText}
//         </span>
//       )}
//     </ListItem>
...
export default function Footer() {
  return (
    // <footer className="bg-background border-t border-background text-default-100 pb-2">
    //   <div className="w-full px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
    //     <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start">
    //       {/* First Col */}
    //       <div className="w-full lg:w-1/4 mb-6 lg:mb-0">
    //         <h5 className="text-gray-700 mb-2 text-sm font-semibold">
    //           Localshop
    //         </h5>
    //         <List lineHeight="2">
    ...
    //       {/* Second Col */}
    //       {/* Replace these by : https://dummyjson.com/products/categories */}
    //       {/* No copy/paste, fetch then map */}
    //       <div className="w-full lg:w-1/4 mb-6 lg:mb-0">
    //         <h5 className="text-gray-700 mb-2 text-sm font-semibold">
    //           Categories
    //         </h5>
    ...
    //       {/* Third Col */}
    //       <div className="w-full lg:w-1/4 mb-6 lg:mb-0">
    //         <Grid justify="start" mb="0.5rem" alignItems="baseline">
    //           <Link href="#" mr="0.5rem">
    //             <svg
