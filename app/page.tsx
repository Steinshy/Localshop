...
const HomePage = async () => {
  ...
  return (
    <>
      <section className="relative bg-cover bg-center -mt-[64px] pt-[64px] min-h-screen flex flex-col items-center p-2" style={{ backgroundImage: `url(${BGImage.src})` }}>
        ...
        <div className="relative text-white px-2 max-w-screen-lg mx-auto h-full flex flex-col flex-grow justify-center">
          ...
          <section className="mt-8">
            <p className="text-xl sm:text-2xl md:text-4xl font-semibold mb-2 flex items-center underline">
              <FaHouse className="inline mr-3" /> Your <span className="ml-1 bg-white text-black p-1 rounded-s-lg">Neighborhood</span>
              <span className="bg-black text-white p-1 rounded-e-lg">Marketplace</span>
            </p>
            <p className="text-md sm:text-lg md:text-xl md:pl-8">
              At LocalShop, we believe in the power of community and the importance of supporting local businesses. Our platform connects you with the best local products, handpicked from your neighborhood&apos;s finest artisans, farmers, and small business owners. By choosing LocalShop, you&apos;re
              not only getting high-quality, unique items but also contributing to the growth and sustainability of your local economy.
            </p>
        ...
        <div className="relative mb-8 text-center">
          <Button as={Link} href="#shopnow" size="md" color="primary" variant="solid" className="mt-4 text-lg text-white" endContent={<FaAppleWhole />}>
            Shop Now
          </Button>
        </div>
      </section>
